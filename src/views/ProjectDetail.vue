...
export default {
  ...
  screenshots: [
    ...
    { src: require('@/assets/screenshots/pathsens/p4.png'), caption: "L'écran liste clairement chaque instruction du trajet (distance et action) pour guider l'utilisateur pas à pas." },
  ],
